...
export class pagesToggleService {
  ...
  private _mobileHorizontalMenu = <Subject<boolean>> new Subject();
  mobileHorizontalMenu = this._mobileHorizontalMenu.asObservable();
  ...
  toggleMobileHorizontalMenu(toggle) {
    this._mobileHorizontalMenu.next(toggle);
  }
